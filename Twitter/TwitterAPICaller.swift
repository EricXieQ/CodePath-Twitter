...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "MaizHLDPGQ94Pd6EiSlTySamZ", consumerSecret: "TFKv3fUmpJVmlp14BSwoG9uGmzZPyd9gNJKp13DRvzIwl033DJ")
    var loginSuccess: (() -> ())?
